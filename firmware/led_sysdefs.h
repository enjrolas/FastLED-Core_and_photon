...
#elif defined(STM32F10X_MD)  //this is defined when we're compiling for the spark
#include "led_sysdefs_arm_stm32.h"
#elif defined(STM32F2XX)  //this is defined when we're compiling for the photon
#include "led_sysdefs_arm_stm32F2XX.h"
#else
// AVR platforms
#define DUMB 1
